...
@section('content')
    <x-breadcrumb section="Pages" page="Cart" />
        ...
        <div class="row">
                        ...
                        <tbody>
                            <tr class="pt-30">
                                ...
                                <td class="image product-thumbnail pt-40"><img
                                        src="{{ asset('assets/client/assets/imgs/shop/product-1-1.jpg') }}" alt="#">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="image product-thumbnail"><img
                                        src="{{ asset('assets/client/assets/imgs/shop/product-2-1.jpg') }}" alt="#">
                                </td>
                                <td class="product-des product-name">
                                    <h6 class="mb-5"><a class="product-name mb-10 text-heading"
            ...
            <div class="col-lg-4">
                ...
                <div class="border p-md-4 cart-totals ml-30">
                        ...
                        <table class="table no-border">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="cart_total_amount">
                                        <h4 class="text-brand text-end">$0.00</h4< /td>
                                </tr>
                                <tr>
                                    <td class="cart_total_label">
                    ...
                    <a href="{{ route('web.checkout-page') }}" class="btn mb-20 w-100">Proceed To
