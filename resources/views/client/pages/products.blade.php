...
@section('content')
    <x-breadcrumb section="Pages" page="All Products" />
            ...
            <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                ...
                <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                    ...
                    <div class="single-post clearfix">
                        <div class="image">
                            <img src="{{ asset('assets/client/assets/imgs/shop/thumbnail-3.jpg') }}" alt="#" />
                        </div>
                    ...
                    <div class="single-post clearfix">
                        <div class="image">
                            <img src="{{ asset('assets/client/assets/imgs/shop/thumbnail-4.jpg') }}" alt="#" />
                        </div>
                        <div class="content pt-10">
                    ...
                    <div class="single-post clearfix">
                        <div class="image">
                            <img src="{{ asset('assets/client/assets/imgs/shop/thumbnail-5.jpg') }}" alt="#" />
                        </div>
                        <div class="content pt-10">
                ...
                <div class="banner-img wow fadeIn mb-lg-0 animated d-lg-block d-none">
                    <img src="{{ asset('assets/client/assets/imgs/banner/banner-11.png') }}" alt="" />
