...
@section('content')
<x-breadcrumb section="Pages" page="About Us" />
            ...
            <div class="row">
                <div class="col-xl-10 col-lg-12 m-auto">
                    <section class="row align-items-center mb-50">
                        <div class="col-lg-6">
                            <img src="{{ asset('assets/client/assets/imgs/page/about-1.png') }}" alt=""
                        ...
                        <div class="col-lg-6">
                            <div class="pl-25">
                                ...
                                <p class="mb-25">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                    ...
                                    irure dolor in reprehenderit in voluptate id est laborum.</p>
                                <p class="mb-50">Ius ferri velit sanctus cu, sed at soleat accusata. Dictas prompta et Ut
                                    placerat legendos interpre.Donec vitae sapien ut libero venenatis faucibus. Nullam quis
                                    ante Etiam sit amet orci eget. Quis commodo odio aenean sed adipiscing. Turpis massa
                                ...
                                <div class="carausel-3-columns-cover position-relative">
                                    ...
                                    <div class="carausel-3-columns" id="carausel-3-columns">
                                        <img src="{{ asset('assets/client/assets/imgs/page/about-2.png') }}"
                                            alt="" />
                                        <img src="{{ asset('assets/client/assets/imgs/page/about-3.png') }}"
                                            alt="" />
                                        <img src="{{ asset('assets/client/assets/imgs/page/about-4.png') }}"
                                            alt="" />
                                        <img src="{{ asset('assets/client/assets/imgs/page/about-2.png') }}"
                                            alt="" />
                                    </div>
                    ...
                    <section class="text-center mb-50">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 mb-24">
                                <div class="featured-card">
                                    <div class="d-flex justify-center">
                                        <img src="{{ asset('assets/client/assets/imgs/theme/icons/icon-1.svg') }}"
                                            alt="" />
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 mb-24">
                                <div class="featured-card">
                                    <div class="d-flex justify-center">
                                        <img src="{{ asset('assets/client/assets/imgs/theme/icons/icon-2.svg') }}"
                                            alt="" />
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 mb-24">
                                <div class="featured-card">
                                    <div class="d-flex justify-center">
                                        <img src="{{ asset('assets/client/assets/imgs/theme/icons/icon-3.svg') }}"
                                            alt="" />
                                    </div>
                                    <h4>Free Delivery</h4>
                                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                            ...
                            <div class="col-lg-4 col-md-6 mb-24">
                                <div class="featured-card">
                                    <div class="d-flex justify-center">
                                        <img src="{{ asset('assets/client/assets/imgs/theme/icons/icon-4.svg') }}"
                                            alt="" />
                                    </div>
                                    <h4>Easy Returns</h4>
                                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                            ...
                            <div class="col-lg-4 col-md-6 mb-24">
                                <div class="featured-card">
                                    <div class="d-flex justify-center">
                                        <img src="{{ asset('assets/client/assets/imgs/theme/icons/icon-5.svg') }}"
                                            alt="" />
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 mb-24">
                                <div class="featured-card">
                                    <div class="d-flex justify-center">
                                        <img src="{{ asset('assets/client/assets/imgs/theme/icons/icon-6.svg') }}"
                                            alt="" />
                                    </div>
                    ...
                    <section class="row align-items-center mb-50">
                        <div class="row mb-50 align-items-center">
                            <div class="col-lg-7 pr-30">
                                <img src="{{ asset('assets/client/assets/imgs/page/about-5.png') }}" alt=""
                            ...
                            <div class="col-lg-5">
                                ...
                                <p class="mb-30">Ed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-lg-0 mb-md-5 mb-sm-5">
                                ...
                                <p class="mb-30">Proin ullamcorper pretium orci. Donec necscele risque leo. Nam massa
                                    dolor imperdiet neccon sequata congue idsem. Maecenas malesuada faucibus finibus.</p>
                                <p class="mb-30">Proin ullamcorper pretium orci. Donec necscele risque leo. Nam massa
                                    dolor imperdiet neccon sequata congue idsem. Maecenas malesuada faucibus finibus.</p>
                            ...
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="team-card">
                                            <img src="{{ asset('assets/client/assets/imgs/page/about-6.png') }}"
                                                alt="" />
                                            <div class="content text-center">
                                                ...
                                                <div class="social-network mt-20">
                                                    <a href="#"><img
                                                            src="{{ asset('assets/client/assets/imgs/theme/icons/icon-facebook-brand.svg') }}"
                                                            alt="" /></a>
                                                    <a href="#"><img
                                                            src="{{ asset('assets/client/assets/imgs/theme/icons/icon-twitter-brand.svg') }}"
                                                            alt="" /></a>
                                                    <a href="#"><img
                                                            src="{{ asset('assets/client/assets/imgs/theme/icons/icon-instagram-brand.svg') }}"
                                                            alt="" /></a>
                                                    <a href="#"><img
                                                            src="{{ asset('assets/client/assets/imgs/theme/icons/icon-youtube-brand.svg') }}"
                                                            alt="" /></a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="team-card">
                                            <img src="{{ asset('assets/client/assets/imgs/page/about-8.png') }}" alt="" />
                                            <div class="content text-center">
