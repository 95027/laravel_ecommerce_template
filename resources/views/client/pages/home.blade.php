                    ...
                    <div class="home-slide-cover">
                        <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1">
                            <div class="single-hero-slider single-animation-wrap"
                                style="background-image: url(assets/client/assets/imgs/slider/slider-3.png)">
                            ...
                            <div class="single-hero-slider single-animation-wrap"
                                style="background-image: url(assets/client/assets/imgs/slider/slider-4.png)">
                                <div class="slider-content">
                                    <h1 class="display-2 mb-40">
                                        Snacks box<br />
                                        daily save
                            ...
                            <div class="single-hero-slider single-animation-wrap"
                                style="background-image: url(assets/client/assets/imgs/slider/slider-7.png)">
                                <div class="slider-content">
                                    <h1 class="display-2 mb-40">
                                        Pure Coffe<br />
                                        Big discount
                            ...
                            <div class="single-hero-slider single-animation-wrap"
                                style="background-image: url(assets/client/assets/imgs/slider/slider-8.png)">
                                <div class="slider-content">
                                    <h1 class="display-2 mb-40">
                                        Snacks box<br />
                                        daily save
                    ...
                    <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="product-img-action-wrap">
                            <div class="product-img">
                                <a href="#">
                                    <img src="{{asset('assets/client/assets/imgs/banner/banner-6.png')}}" alt="" />
                                </a>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                            ...
                            <div class="deals-content">
                                <h2><a href="#">Seeds of Change Organic Quinoa, Brown, & Red Rice</a>
                                </h2>
                ...
                <div class="title">
                    ...
                    <ul class="list-inline nav nav-tabs links">
                        ...
                        <li class="list-inline-item nav-item"><a class="nav-link active" href="#">Pet
                                Foods</a></li>
                        <li class="list-inline-item nav-item"><a class="nav-link" href="#">Vegetables</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="carausel-10-columns-cover position-relative">
                <div class="carausel-10-columns" id="carausel-10-columns">
                    ...
                    <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="{{ asset('assets/client/assets/imgs/shop/cat-11.pn') }}g"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="{{ asset('assets/client/assets/imgs/shop/cat-9.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-13 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="{{ asset('assets/client/assets/imgs/shop/cat-3.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-14 wow animate__animated animate__fadeInUp" data-wow-delay=".6s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="{{ asset('assets/client/assets/imgs/shop/cat-1.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-15 wow animate__animated animate__fadeInUp" data-wow-delay=".7s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="{{ asset('assets/client/assets/imgs/shop/cat-2.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".8s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="{{ asset('assets/client/assets/imgs/shop/cat-4.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".9s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="{{ asset('assets/client/assets/imgs/shop/cat-5.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="{{ asset('assets/client/assets/imgs/shop/cat-14.pn') }}g"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay="0s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="#"><img src="{{ asset('assets/client/assets/imgs/shop/cat-15.pn') }}g"
                                    alt="" /></a>
                        </figure>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <img src="{{ asset('assets/client/assets/imgs/banner/banner-1.png') }}" alt="" />
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        <img src="{{ asset('assets/client/assets/imgs/banner/banner-2.png') }}" alt="" />
                        <div class="banner-text">
                            <h4>
                ...
                <div class="col-lg-4 d-md-none d-lg-flex">
                    <div class="banner-img mb-sm-0 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        <img src="{{ asset('assets/client/assets/imgs/banner/banner-3.png') }}" alt="" />
                        <div class="banner-text">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details',$product->id) }}">
                                            <img class="default-img" src="{{ asset('storage/products/' . $product->media->where('featured', 1)->first()->file_name) }}" alt="">
                                            <img class="hover-img" src="{{ asset('storage/products/' . $product->media->where('featured', 1)->first()->file_name) }}" alt="">
                                        </a>
                                    </div>
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ route('web.product.details', $product->id) }}">{{$product->title}}</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                                            <div class="product-rating" style="width: 90%"></div>
                                        </div>
                                    ...
                                    <div>
                                        <span class="font-small text-muted">By <a
                                                href="vendor-details-1.html">{{$product->brand->name}}</a></span>
                                    </div>
                                    <div class="product-card-bottom">
                                        <div class="product-price">
                                            <span>$28.85</span>
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                ...
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-2-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ route('web.product.details', $product->id) }}">All Natural Italian-Style Chicken
                                            Meatballs</a>
                                    </h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                ...
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-3-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ route('web.product.details', $product->id) }}">Angie’s Boomchickapop Sweet & Salty
                                            Kettle
                                            Corn</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                ...
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-4-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ route('web.product.details', $product->id) }}">Foster Farms Takeout Crispy Classic
                                            Buffalo
                                            Wings</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                ...
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-5-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ route('web.product.details', $product->id) }}">Blue Diamond Almonds Lightly Salted
                                            Vegetables</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                                            <div class="product-rating" style="width: 90%"></div>
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                ...
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-10-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="{{ route('web.product.details', $product->id) }}">Seeds of Change Organic Quinoa,
                                            Brown, & Red
                                            Rice</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-12-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-12-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-13-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-13-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-14-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-14-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-15-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-15-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                ...
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-9-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                ...
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-8-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                ...
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-7-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                ...
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-6-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('web.product.details', $product->id) }}">
                                            <img class="default-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-16-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('assets/client/assets/imgs/shop/product-16-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns">
                                            ...
                                            <div class="product-img product-img-zoom">
                                                <a href="#">
                                                    <img class="default-img"
                                                        ...
                                                        alt="" />
                                                    <img class="hover-img"
                                                        src="{{ asset('assets/client/assets/imgs/shop/product-1-2.jpg') }}"
                                                        alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                    ...
                                    <div class="product-cart-wrap">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a href="#">Angie’s Boomchickapop Sweet and
                                                    womnies</a></h2>
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 80%"></div>
                                            </div>
                                    ...
                                    <div class="product-cart-wrap">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a href="#">Foster Farms Takeout Crispy Classic </a>
                                            </h2>
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 80%"></div>
                                            </div>
                                    ...
                                    <div class="product-cart-wrap">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a href="#">Blue Diamond Almonds Lightly Salted</a>
                                            </h2>
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 80%"></div>
                                            </div>
                                ...
                                <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns-2">
                                    <div class="product-cart-wrap">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a href="#">Canada Dry Ginger Ale – 2 L Bottle</a>
                                            </h2>
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 80%"></div>
                                            </div>
                                ...
                                <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns-3">
                                    <div class="product-cart-wrap">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a href="#">Perdue Simply Smart Organics Gluten
                                                    Free</a></h2>
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 80%"></div>
                                            </div>
                                    ...
                                    <div class="product-cart-wrap">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a href="#">Simply Lemonade with Raspberry Juice</a>
                                            </h2>
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 80%"></div>
                                            </div>
                                    ...
                                    <div class="product-cart-wrap">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a href="#">Organic Quinoa, Brown, & Red Rice</a>
                                            </h2>
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 80%"></div>
                                            </div>
