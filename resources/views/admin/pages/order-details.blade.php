...
@section('content')
    <div class="mx-auto max-w-7xl mt-2">
        <div
                ...
                <div class="rounded-lg bg-gray-50 shadow-sm ring-1 ring-gray-900/5 pb-6">
                    <dl class="flex flex-wrap">
                        ...
                        <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
                            ...
                            <dd class="text-sm leading-6 text-gray-500"><a href="mailto:alexcurren@gmail.com"
                                    class="hover:text-blue-400">alexcurren@gmail.com</a></dd>
                        </div>
                    </dl>
                    <div class="px-6 pt-4">
            ...
            <!-- Invoice -->
            <div
                class="-mx-4 shadow-sm ring-1 ring-gray-900/5 sm:mx-0 sm:rounded-lg sm:px-8 sm:pb-14 lg:col-span-2 lg:row-span-2 lg:row-end-2 xl:pb-20 xl:pt-8 flex flex-col">
                <h2 class="text-base font-semibold leading-6 text-gray-900">Order No. <a href="#"
                        class="text-xl hover:text-blue-400">#123456</a></h2>
                <dl class="flex flex-wrap text-sm leading-6 justify-between items-center">
                    ...
                    <div class="flex-none self-end">
                        ...
                        <dd
                            class="rounded-md bg-yellow-50 px-2 py-1 text-xs font-medium text-yellow-600 ring-1 ring-inset ring-yellow-600/20">
                            Pending</dd>
                    </div>
                </dl>
                <table class="mt-4 w-full whitespace-nowrap text-left text-sm leading-6">
                            ...
                            <td class="max-w-0 px-0 py-5 align-top">
                                <div class="flex items-center">
                                    <div class="h-11 w-11 flex-shrink-0">
                                        <img class="h-11 w-11 rounded-lg"
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <th scope="row" colspan="3"
                                class="hidden pt-4 text-right font-normal text-gray-700 sm:table-cell">Discount</th>
                            <td class="pb-0 pl-8 pr-0 pt-4 text-right tabular-nums text-gray-900">$1,760.00</td>
                        </tr>
                        <tr>
                            <th scope="row" class="pt-4 font-normal text-gray-700 sm:hidden">Tax</th>
                            <th scope="row" colspan="3"
                                class="hidden pt-4 text-right font-normal text-gray-700 sm:table-cell">Tax (18%)</th>
                            <td class="pb-0 pl-8 pr-0 pt-4 text-right tabular-nums text-gray-900">$1,760.00</td>
                        </tr>
        ...
        <div
            class="-mx-4 max-w-3xl shadow-sm ring-1 ring-gray-900/5 sm:mx-0 sm:rounded-lg sm:px-8 sm:pb-14 xl:pb-20 xl:pt-8 mt-6">
            <div class="flow-root">
