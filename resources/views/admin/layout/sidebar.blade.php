    ...
    <div class="menu p-3 m-0 h-screen overflow-y-auto">
        <ul class="space-y-2">
            ...
            <div class="mb-4">
                ...
                <li
                    class="m-1 {{ request()->routeIs('employee') ? 'bg-blue-200 bg-opacity-60 rounded-md text-blue-600 shadow-2xl font-bold border-l-4 border-blue-500' : '' }}">
                    <a href="#" class="text-md flex items-center hover:text-blue-700 p-2">
                        <i class="fa-solid fa-users text-xl me-2"></i>Employees</a>
                </li>
            </div>
            <div class="mb-4">
                ...
                <li class="dropdown m-1">
                    <a
                        class="dropdown-toggle  text-md flex items-center justify-between hover:text-blue-700 p-2 {{ request()->routeIs('product', 'category', 'category.sub-category', 'brand') ? 'bg-blue-200 bg-opacity-60 rounded-md text-blue-600 border-l-4 border-blue-500' : '' }}">
            ...
            <div class="mb-4">
                ...
                <li class="dropdown m-1">
                    <a href="#"
                        class="dropdown-toggle   text-md flex items-center justify-between  hover:text-blue-700 p-2 {{ request()->routeIs('allOrders') ? 'bg-blue-200 bg-opacity-60 rounded-md text-blue-600 shadow-2xl border-l-4 border-blue-500' : '' }}">
            ...
            <div class="mb-4">
                ...
                <li
                    class="m-1 {{ request()->routeIs('contactForm') ? 'bg-blue-200 bg-opacity-60 rounded-md text-blue-600 shadow-2xl font bold border-l-4 border-blue-500' : '' }}">
            ...
            <div class="mb-4">
                ...
                <li
                    class="m-1 {{ request()->routeIs('support-ticket') ? 'bg-blue-200 bg-opacity-60 rounded-md text-blue-600 shadow-2xl font bold border-l-4 border-blue-500' : '' }}">
                    <a href="#" class="text-md flex items-center hover:text-blue-700 p-2">
            ...
            <div class="mb-4">
                ...
                <li
                    class="m-1 {{ request()->routeIs('reviewPage') ? 'bg-blue-200 bg-opacity-60 rounded-md text-blue-600 shadow-2xl font bold border-l-4 border-blue-500' : '' }}">
            ...
            <div class="mb-4">
                ...
                <li
                    class="m-1 {{ request()->routeIs('coupon') ? 'bg-blue-200 bg-opacity-60 rounded-md text-blue-600 shadow-2xl font bold border-l-4 border-blue-500' : '' }}">
                    <a href="#" class="text-md flex items-center hover:text-blue-700 p-2">
            ...
            <div class="mb-4">
                ...
                <li class="dropdown m-1">
                    <a href="#"
                        class="dropdown-toggle   text-md flex items-center justify-between hover:text-blue-700 p-2 {{ request()->routeIs('admin.user') ? 'bg-blue-200 bg-opacity-60 rounded-md text-blue-600 shadow-2xl border-l-4 border-blue-500' : '' }}">
