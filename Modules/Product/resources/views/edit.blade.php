...
@section('content')
    ...
    <div class="container mx-auto mt-3">
        ...
        <form id="add-product" data-parsley-validate action="{{ route('product.update', $product->id) }}" method="POST"
                            ...
                            <div class="grid grid-cols-2 gap-2 gap-y-6 mb-4">
                                    ...
                                    <select name="brandId" required
                                        ...
                                        @foreach ($brands as $brand)
                                            <option value="{{ $brand->id }}"
                                                {{ old('brandId', $product->brand_id) == $brand->id ? 'selected' : '' }}>
                                                {{ $brand->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="max-w-full">
                                    <label for="textarea-label-with-helper-text"
                                        class="block text-sm font-medium mb-2 dark:text-white">Short
                                    ...
                                    <textarea id="textarea-label-with-helper-text" required name="short_description"
                                        ...
                                        rows="3" placeholder="Say hi, we'll be happy to chat with you." aria-describedby="hs-textarea-helper-text">{{ old('short_description', $product->short_description) }}</textarea>
                                </div>
                                <div class="max-w-full">
                                    <label for="textarea-label-with-helper-text"
                    ...
                    <div id="vertical-tab-with-border-3" class="hidden step-content" role="tabpanel"
                        ...
                        <div class="shadow-2xl rounded-2xl p-8 grid grid-cols-2 gap-2">
                            <div class="max-w-full mb-4">
                                ...
                                <input type="text" id="input-label" required value="{{ old('sku', $product->sku) }}"
                            ...
                            <div class="max-w-full mb-4">
                                ...
                                <input type="number" id="input-label" required
                                    class="py-3 px-4 block w-full border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-0"
                                    placeholder="10" name="quantity" value="{{ old('quantity', $product->quantity) }}">
                            </div>
                            {{-- <div class="max-w-full">
                        ...
                        <div class="shadow-2xl rounded-2xl p-8 grid grid-cols-2 gap-2">
                            <div class="max-w-full mb-4">
                                ...
                                <input type="number" name="mrp" id="input-label" required
                                    class="py-3 px-4 block w-full border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-0"
                                    placeholder="999" value="{{ old('mrp', $product->mrp) }}">
                            </div>
                            <div class="max-w-full">
                                <label for="textarea-label" class="block text-sm font-medium mb-2 dark:text-white">Sale
                                    Price</label>
                                <input type="number" name="price" id="input-label"
                                    class="py-3 px-4 block w-full border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-0"
                                    placeholder="799" value="{{ old('price', $product->price) }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="shadow-2xl rounded-2xl p-8">
                            <div class="max-w-full mb-4">
                                ...
                                <input type="text" id="input-label"
                                    class="py-3 px-4 block w-full border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-0"
                                    placeholder="Product Meta Title" name="product_meta_title" value="">
                            </div>
                            <div class="max-w-full">
