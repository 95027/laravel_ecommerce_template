        ...
        <table class="min-w-full table-auto bg-white">
            <div class="flex justify-between">
                <div class="max-w-xs mb-4">
                    <input type="text" id="searchOrderNumber" name="order_number" class="py-2 px-4 block w-full border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-0" placeholder="Search by order number">
                </div>
                <div class="flex gap-2">
                    ...
                    <div>
                        <input type="date" id="searchDate" name="date" class="py-2 px-4 block w-full border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-0">
                    </div>
                </div>
            </div>
            <thead>
                ...
                <tr>
                    ...
                    <td class="py-3">
                        <div class="flex items-center gap-2">
                            <span class="bg-sky-300 bg-opacity-80 w-12 h-12 rounded-full text-sky-800 text-xl font-bold flex justify-center items-center">JD
                            </span>
                            <div>
                    ...
                    <td class="py-3 text-center flex justify-evenly">
                        <a href="{{ route('order.show', 1) }}" class="bg-blue-300 bg-opacity-60 hover:text-blue-600 p-1 w-8 h-8 rounded-lg flex justify-center items-center cursor-pointer"><i class="fa-regular fa-eye"></i></a>
                        {{-- <a
