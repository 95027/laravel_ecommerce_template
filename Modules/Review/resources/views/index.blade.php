            ...
            <div class="border-b border-gray-200">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    ...
                    <a href="#"
                        ...
                        <svg class="-ml-0.5 mr-2 h-5 w-5 text-gray-400 group-hover:text-gray-500" viewBox="0 0 20 20"
                    ...
                    <a href="#"
                        ...
                        aria-current="page">
                        <svg class="-ml-0.5 mr-2 h-5 w-5 text-indigo-500" viewBox="0 0 20 20" fill="currentColor"
                            aria-hidden="true">
                            <path
